- [2025-04-26] Version =1.12.0=
  + Support capture online video clip or gif when ab-loop
  + =org-media-note-open-url-at-point= open online video timestamp url
  + =org-media-note-copy-mpv-command= copy command to debug 
  + remove hydra, remove dependency of org-ref, s.el
